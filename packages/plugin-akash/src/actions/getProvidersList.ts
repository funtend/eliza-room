...
function filterProviders(
    ...
    filter?: GetProvidersListContent["filter"]
): ProviderInfo[] {
...
export const getProvidersListAction: Action = {
    ...
    description:
        "Get a list of all available providers on the Akash Network with their details and status",
    examples: [
        [
            {
                user: "user",
        ...
        try {
            ...
            if (params.filter) {
                if (
                    ...
                    typeof params.filter.region !== "string"
                ) {
                    throw new AkashError(
                ...
                if (
                    params.filter.active !== undefined &&
                    typeof params.filter.active !== "boolean"
                ) {
                    throw new AkashError(
                ...
                if (
                    params.filter.hasGPU !== undefined &&
                    typeof params.filter.hasGPU !== "boolean"
                ) {
                    throw new AkashError(
                    ...
                    content: {
                        ...
                        data: {
                            ...
                            providers: filteredProviders.map((p) => ({
                                ...
                                hostUri: p.hostUri,
                                active:
                                    p.active && p.status?.available !== false,
                                uptime: p.uptime,
