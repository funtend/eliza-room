...
export type GetTopGainersLosersContent = z.infer<
    typeof GetTopGainersLosersSchema
> &
    Content;

export const isGetTopGainersLosersContent = (
    obj: any
): obj is GetTopGainersLosersContent => {
...
export default {
    ...
    description:
        "Get list of top gaining and losing cryptocurrencies by price change",
    handler: async (
        ...
        try {
            ...
            const responseText = [
                ...
                ...response.data.top_gainers.map((coin, index) => {
                    const changeKey =
                        `usd_${content.duration}_change` as keyof TopGainerLoserItem;
            ...
            elizaLogger.error(
                "Error in GET_TOP_GAINERS_LOSERS handler:",
                error
            );
