...
export const validateSettings = (runtime: IAgentRuntime) => {
    const requiredSettings = ["QUAI_PRIVATE_KEY", "QUAI_RPC_URL"];
...
export function isTransferContent(content: any): content is TransferContent {
    ...
    const validRecipient =
        content.recipient.startsWith("0x") && content.recipient.length === 42;
